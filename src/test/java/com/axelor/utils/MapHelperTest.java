...
class MapHelperTest extends BaseTest {
  ...
  @Inject
  MapHelperTest(LoaderHelper loaderHelper, UserRepository userRepository) {
  ...
  @Test
  void testSimplify() {
    Map<String, Object> mapStringObject = MapHelper.simplifyMap(mapStringListString);
