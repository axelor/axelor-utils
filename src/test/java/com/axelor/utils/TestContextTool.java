...
class TestContextTool extends BaseTest {

  protected final LoaderHelper loaderHelper;
  protected final UserRepository userRepository;

  @Inject
  TestContextTool(LoaderHelper loaderHelper, UserRepository userRepository) {
  ...
  void getFieldFromContextParent_whenObjectInContext() {
    ...
    String code = ContextTool.getFieldFromContextParent(moveCtx, "code", String.class);
  ...
  void getFieldFromContextParent_whenObjectInParentContext() {
    ...
    String code = ContextTool.getFieldFromContextParent(moveLineCtx, "code", String.class);
  ...
  void getFieldFromContextParent_whenObjectInParentParentContext() {
    ...
    Context moveLineCtx = new Context(2L, MoveLine.class);
    moveLineCtx.put("_parent", moveCtx);
    String password = ContextTool.getFieldFromContextParent(moveLineCtx, "password", String.class);
