...
class LocalDateHelperLocalDateTimeUtilsGetNearMonthOccurenceBoundariesTest {
  ...
  void test01() {
    ...
    MonthBoundaries actual =
        LocalDateHelper.getLastMonthOccurenceBoundaries(targetMonth, referenceDate);
    ...
    actual = LocalDateTimeHelper.getLastMonthOccurenceBoundaries(targetMonth, referenceDateTime);
    assertEquals(expected, actual);

    actual = LocalDateHelper.getNextMonthOccurenceBoundaries(targetMonth, referenceDate);
    expected = new MonthBoundaries();
    expected.firstDayOfMonth = LocalDate.of(2024, 1, 1);
    expected.lastDayOfMonth = LocalDate.of(2024, 1, 31);
    assertEquals(expected, actual);

    actual = LocalDateTimeHelper.getNextMonthOccurenceBoundaries(targetMonth, referenceDateTime);
    assertEquals(expected, actual);
  }
