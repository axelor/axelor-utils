...
class LocalDateTimeUtilsGetMergedIntervalContainingInstantTest {
  ...
  void getMergedIntervalContainingInstant_twoOverlappingBoundedIntervalsContainingTheInstant() {
    ...
    LocalDateTimeInterval actual =
        LocalDateTimeUtils.getMergedIntervalContainingInstant(intervals, T);
  ...
  void getMergedIntervalContainingInstant_manyIntervalAndTheInstantIsBeforeTheStartOfAnyOfThem() {
    ...
    actual = LocalDateTimeUtils.getMergedIntervalContainingInstant(intervals, T);
    expected = null;
  ...
  void getMergedIntervalContainingInstant_emptyIntervalCollection() {
    ...
    LocalDateTimeInterval actual =
        LocalDateTimeUtils.getMergedIntervalContainingInstant(Collections.emptyList(), T);
    LocalDateTimeInterval expected = null;
  ...
  void getMergedIntervalContainingInstant_nullIntervalCollection() {
    ...
    LocalDateTimeInterval actual = LocalDateTimeUtils.getMergedIntervalContainingInstant(null, T);
    LocalDateTimeInterval expected = null;
  ...
  void getMergedIntervalContainingInstant_nullInstant() {
    ...
    Assertions.assertThrows(
        ...
        () -> LocalDateTimeUtils.getMergedIntervalContainingInstant(intervals, null));
  }
}
